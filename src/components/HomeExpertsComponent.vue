<template>
  <div id="HomeExpertsComponent">
    <div class="title">专家推荐</div>
    <div
      class="content"
      @mouseenter="onMouseMoveEnter"
      @mouseleave="onMouseMoveLeave"
    >
...
#HomeExpertsComponent > .title {
  float: left;
}
#HomeExpertsComponent > .content {
  float: left;
  clear: both;
  width: 100%;
  height: 300px;
